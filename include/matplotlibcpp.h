...
inline void imshow(const std::vector<std::vector<double>>& data, 
    const std::string& cmap = "viridis", 
    const std::string& origin = "upper",
    const std::string& interpolation = "nearest") 
{
    ...
    PyObject* plot_result = PyObject_Call(
        PyObject_GetAttrString(PyImport_ImportModule("matplotlib.pyplot"), "imshow"),
        plot_args, kwargs);
