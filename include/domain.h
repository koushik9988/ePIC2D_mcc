...
class Domain
{
    ...
    bool enable_pion_elastic;         // Flag for positive ion elastic collisions (hydrogen)
    bool enable_nion_elastic;         // Flag for negative ion elastic collisions (hydrogen)
    bool enable_e_detach_collision;   // Flag for electron detachment collisions (hydrogen)
    double GAS_DENSITY;
    ...
    vec<double> Compute_PE(Species &species);
